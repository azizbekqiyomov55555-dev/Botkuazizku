...
async def check_sub(uid):
    ...
    not_joined = []
    for ch in chans:
        if ch['cid'] in ("link", "private"):
            # Oddiy havola yoki shaxsiy — tekshirish yo'q, faqat ko'rsatiladi
...
async def cb_chtype(call: types.CallbackQuery, state: FSMContext):
    ...
    if t == "link":
        ...
        await call.message.answer(
            "🔐 Kanal/guruh havolasini kiriting (https://t.me/+...):",
            reply_markup=kb_back())
